...
export default function RecommendationPage() {
    return (
        <main>
            ...
            <div className="flex h-[90vh] w-full left-center items-center text-center">
                 <div className="bg-[#33cc33] h-[2.8rem] w-[6rem] absolute top-150 ml-[335px] rounded-[15px]">
            ...
            <div className="flex h-[90vh] w-full left-center items-center text-center">
                 <div className="bg-[#cc3333] h-[2.8rem] w-[6rem] absolute top-150 ml-[125px] rounded-[15px]">
                    {/*You can put an icon here if you want. I would need the icon files though*/}
                </div>
            </div>
