            ...
            <section className="flex h-[90vh] space-x-[5%] px-[5%] w-full items-center justify-center mt-[3vh]">
                {!displayedMovie && !isLoadingState ? (
                    ...
                    <div className="flex items-center">
                        ...
                        <section className="flex flex-col justify-center items-center h-[32.5rem] w-[30rem]">
                        ...
                        <section className="flex flex-col space-y-[1vh] bg-[#394B51] h-fit w-[50.5rem] px-[0.5vw] py-[2.5vh] rounded-xl shadow-md shadow-black">
                            ...
                            <div className={`flex h-fit pb-[2px] flex-col space-y-[1vh] transition-opacity duration-300 ${showContent ? 'opacity-100' : 'opacity-0'}`}>
                                <div className="flex items-center justify-between w-[96%]">
                                    <span className="bold text-white text-left text-3xl font-semibold ml-[1vw] truncate w-[65%] oveflow-auto">
                                ...
                                {/*Actors*/}
                                <div className="flex flex-col ml-[1vw] space-x-[20px]">
                                    <span className="text-left text-lg font-semibold text-gray-300"> Actors: </span>
                                    <div className="flex space-x-2 space-y-2 mt-2 w-full flex-wrap">
                                        {displayedMovie?.actors.slice(0, 7).map((actor: string, idx: number) => (
                                            <div
                                                key={idx}
                                                className="inline-flex items-center bg-teal-500/20 text-teal-200 text-sm font-medium rounded-full border border-teal-400/50 px-3
                                                    py-1 shadow-sm hover:bg-teal-500/30 transition-colors"
                                        ...
                                        {displayedMovie?.actors.length > 5 && (
                                            <Dialog>
                                                <DialogTrigger asChild>
                                                    <button className="inline-flex items-center bg-teal-500/20 text-teal-200 text-sm font-medium rounded-full border border-teal-400/50 px-2
                                                            py-1 shadow-sm hover:bg-teal-500/30 transition-colors h-7.5"
                                                    >
                                                ...
                                                <DialogContent>
                                                    ...
                                                    <DialogHeader>
                                                        <DialogTitle className="text-xl">{displayedMovie.title} Actors:</DialogTitle>
                                                        <span>{displayedMovie.actors.join(', ')}</span>
                                                    </DialogHeader>
                                                </DialogContent>
                                                </DialogContent>
                                            </Dialog>
                                ...
                                <div className="bg-[#375367] h-[11.7rem] text-start px-4 py-2 mt-[20px] w-[94%] rounded-[15px] overflow-auto ml-[1vw] border-[0.1rem] border-[#20363e]">
